...
const TOOLS = [
  { id: 'single', icon: 'trophy', title: 'Single Winner',        desc: 'Crown one winner from the pool with a dramatic spin and a satisfying reveal.' },
  { id: 'turn',   icon: 'list',   title: 'Sequence / Turn Order', desc: 'Randomize the order of a list. Numbered, animated, and impossible to argue with.' },
  { id: 'role',   icon: 'tag',    title: 'Role Assigner',         desc: 'Give each player a randomly assigned role from your custom set.' },
  { id: 'team',   icon: 'users',  title: 'Team Maker',            desc: 'Split your group into balanced teams. Set count or size — Pickit makes it fair.' },
]
  ...
  return (
    <div className="page">
      <section className="home-hero">
        <div>
          ...
          <p className="headline-sub">
            Four randomizers for groups, games, classrooms, and events. No sign-ups, no setup —
        ...
        <div className="chip-stack">
          <div className="chip chip-1">4</div>
      ...
      <section className="stat-strip">
        <div className="stat"><div className="n"><em>4</em> tools</div><div className="lbl">Built for any moment</div></div>
      ...
      <section id="tools">
        <div className="tools-section-head">
          <span className="cat-tag">Pick your tool</span>
          <h2>All Randomizers</h2>
          <hr />
        </div>
